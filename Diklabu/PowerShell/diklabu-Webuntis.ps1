...
.DESCRIPTION
   Anmelden an Webuntis
.EXAMPLE
   login-Untis -url https://demo.webuntis.com/WebUntis/jsonrpc.do?school=demo_kb -credentails (get-cretendials Goethe)
...
function Login-Untis
{
    ...
    Begin
    {
        ...
        $ks=Set-Keystore -key "webuntis" -server $base -credential $credential       
    }
}
