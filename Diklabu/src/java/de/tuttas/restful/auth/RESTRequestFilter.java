...
public class RESTRequestFilter implements ContainerRequestFilter {
    ...
    public void filter(ContainerRequestContext requestCtx) throws IOException {
        ...
        Log.d("path=(" + path + ")");
        if (path.startsWith("/noauth") || path.startsWith("noauth") || !Config.getInstance().auth) {
            ...
            if (!path.startsWith("/auth/login") && !path.startsWith("auth/login") && 
                !path.startsWith("/auth/logout") && !path.startsWith("auth/logout") && 
                !path.startsWith("/auth/setpin") && !path.startsWith("auth/setpin") ) {
